...
description: Maintain a filesystem-first Obsidian knowledge base for a research project, including durable context, plans, experiments, results, and writing.
metadata:
  codex-migrated-from: dotfiles/claude/skills/obsidian-project-memory
---
