...
description: Detach, archive, purge, rename, or rebuild an Obsidian project knowledge base using the bundled lifecycle workflow.
metadata:
  codex-migrated-from: dotfiles/claude/skills/obsidian-project-lifecycle
---
