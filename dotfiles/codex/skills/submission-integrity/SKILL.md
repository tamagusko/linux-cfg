...
description: Audit a manuscript before submission for reference errors, self-overlap, text recycling, and passages too close to cited sources.
metadata:
  codex-migrated-from: dotfiles/claude/skills/submission-integrity
---
