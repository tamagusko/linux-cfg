---
name: graphify
description: Query or update a repository knowledge graph when graphify-out exists, or build a persistent graph from code, documents, papers, images, or video.
metadata:
  codex-migrated-from: dotfiles/claude/skills/graphify
---
