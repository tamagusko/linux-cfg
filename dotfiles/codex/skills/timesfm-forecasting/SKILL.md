...
description: Run zero-shot univariate time-series forecasting with TimesFM, including environment preflight, point forecasts, and prediction intervals.
license: Apache-2.0 license
metadata:
  skill-author: Clayton Young / Superior Byte Works, LLC (@borealBytes)
  skill-version: 1.0.0
  codex-migrated-from: dotfiles/claude/skills/timesfm-forecasting
---
