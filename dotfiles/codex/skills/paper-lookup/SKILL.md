---
name: paper-lookup
description: Search scholarly databases for papers, metadata, citations, abstracts, full text, and open-access copies, or test whether a research idea is novel.
metadata:
  codex-migrated-from: dotfiles/claude/skills/paper-lookup
---
...
|---|---|---|
| Codex | `open or fetch the source` | `curl` via Bash |
