...
description: Move Zotero collections, metadata, and full text into durable Obsidian paper notes and refresh the project literature canvas.
metadata:
  codex-migrated-from: dotfiles/claude/skills/zotero-obsidian-bridge
---
