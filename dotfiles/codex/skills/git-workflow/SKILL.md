---
name: git-workflow
description: Manage commits, branches, merge conflicts, pull requests, and Conventional Commits when the user requests Git workflow help.
metadata:
  codex-migrated-from: dotfiles/claude/skills/git-workflow
---
