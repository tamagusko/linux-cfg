...
description: Develop research questions through literature discovery, gap analysis, method selection, and an actionable research plan.
metadata:
  codex-migrated-from: dotfiles/claude/skills/research-ideation
---
...
- Search via web search across academic databases (arXiv, Google Scholar, etc.)
...
- **Paper Discovery**: web search finds relevant papers across academic databases
...
- **`references/zotero-integration-guide.md`** - Zotero MCP Integration Guide
  ...
  - Automated workflow: web search → DOI → Zotero import → PDF attach
