...
description: Record research progress, plans, meetings, milestones, and TODOs in the project's Obsidian daily notes and hub.
metadata:
  codex-migrated-from: dotfiles/claude/skills/obsidian-research-log
---
