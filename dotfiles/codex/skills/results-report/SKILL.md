---
name: results-report
description: Turn completed experiment artifacts into a structured results report with evidence, interpretation, decisions, and project-memory updates.
metadata:
  codex-migrated-from: dotfiles/claude/skills/results-report
---
