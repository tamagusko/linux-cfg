...
description: Analyze experimental results with rigorous statistics, model comparisons, significance tests, ablations, and scientific figures.
metadata:
  codex-migrated-from: dotfiles/claude/skills/results-analysis
---
