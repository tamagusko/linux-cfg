...
description: Edit English or Chinese prose to remove recurring AI-writing patterns and make the result sound natural while preserving meaning and evidence.
license: MIT
metadata:
  codex-migrated-from: dotfiles/claude/skills/writing-anti-ai
---
