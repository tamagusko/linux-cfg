...
description: Analyze reviewer comments and draft a professional point-by-point rebuttal or revision response for an academic manuscript.
metadata:
  codex-migrated-from: dotfiles/claude/skills/review-response
---
...
1. **Provide reviewer comments** - Share the reviewer comments text or file with Codex
2. **Analysis and classification** - Codex automatically parses and classifies the comments
...
- `~/.agents/skills/ml-paper-writing/references/knowledge/paper-miner-writing-memory.md`
