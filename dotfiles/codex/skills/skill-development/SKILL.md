...
description: Create, repair, or reorganize a local skill, improve its trigger description, and verify that its bundled resources and references are coherent.
metadata:
  codex-migrated-from: dotfiles/claude/skills/skill-development
---

# Skill Development

Use this skill to create or repair skills in the **current local environment**, not in an abstract plugin template.
