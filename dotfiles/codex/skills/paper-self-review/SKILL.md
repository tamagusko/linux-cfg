...
description: Run the final pre-submission review of the user's own settled manuscript. Use for a last pass or final polish; use paper-review for someone else's manuscript.
metadata:
  codex-migrated-from: dotfiles/claude/skills/paper-self-review
---
