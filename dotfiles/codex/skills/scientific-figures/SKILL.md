...
description: Audit or produce publication-ready plots, schematics, tables, equations, and algorithm listings as a coherent manuscript visual system.
metadata:
  codex-migrated-from: dotfiles/claude/skills/scientific-figures
---
