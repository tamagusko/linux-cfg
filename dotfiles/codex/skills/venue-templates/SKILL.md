...
description: Find and apply venue-specific LaTeX templates and submission formatting for major journals, conferences, posters, and grant proposals.
license: MIT license
metadata:
  skill-author: K-Dense Inc.
  codex-migrated-from: dotfiles/claude/skills/venue-templates
---
