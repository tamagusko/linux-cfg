...
description: Reconcile the manuscript tracker with the papers repository and Git history to report current submissions, inactivity, and inconsistencies.
metadata:
  codex-migrated-from: dotfiles/claude/skills/manuscript-pipeline
---
...
```bash
python3 ~/.agents/skills/manuscript-pipeline/scripts/pipeline_status.py
```
