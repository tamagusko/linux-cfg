...
description: Record experiment designs, runs, baselines, metrics, failures, ablations, and interpretations in Obsidian project notes.
metadata:
  codex-migrated-from: dotfiles/claude/skills/obsidian-experiment-log
---
