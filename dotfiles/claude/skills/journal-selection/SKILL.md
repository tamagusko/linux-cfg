...
description: Use when deciding where to submit a manuscript in progress — "where should I submit this", "find journals for this paper", "rank venues", "is TR-C the right target", "we got rejected, where next". Also use when a draft names a target journal and that choice needs an honest second opinion before submission.
---
